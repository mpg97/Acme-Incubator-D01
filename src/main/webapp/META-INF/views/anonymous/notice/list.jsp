...
<acme:list>
	...
	<acme:list-column code="anonymous.notice.list.label.body" path="body" width="40%"/>
	...
	<acme:list-column code="anonymous.notice.list.label.header" path="header" width="40%"/>		
